...
<th><img src="img/peerless.jpg" align="left" width="120px" height="120px" class="zoom">
</th>
<th>
<h1 align="center"><font color ="white">Peerless Hospital And B.K.Roy Research Centre Ltd.</font></h1>
<h3 align="center"><font color ="white"> 360 Panchasayar, Kolkata - 700094</font></h3>
<h4 align="center"><font color ="white"><b><i class="fa fa-phone" style="font-size:18px"></i> +91 9433129040</b></h4></font>
</th>
<th>
...
<div id="main">
					...
					<center>
                    	<table border="0" cellpadding="2" cellspacing="10">
                            ...
                            <?php
								$result=mysqli_query($conn,"SELECT * FROM `peerless`");
...
{
	$beds = $_POST['beds'];
	$sql="UPDATE `peerless_beds` SET `beds` ='$beds'";
...
<tr>
<?php
								$result=mysqli_query($conn,"SELECT * FROM `peerless_open`");
								while($row=mysqli_fetch_assoc($result))
								{
