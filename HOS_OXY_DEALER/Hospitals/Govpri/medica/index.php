...
<th><img src="img/medica.jpg" align="left" width="120px" height="120px" class="zoom">
</th>
<th>
<h1 align="center"><font color ="white">Medica Superspecialty Hospital</font></h1>
<h3 align="center"><font color ="white">Kolkata, West Bengal, Kolkata - 700099</font></h3>
<h4 align="center"><font color ="white"><b><i class="fa fa-phone" style="font-size:18px"></i>  7044025090 / 91-9830720624</b></h4></font>
</th>
<th>
...
<div id="main">
					...
					<center>
                    	<table border="0" cellpadding="2" cellspacing="10">
                            ...
                            <?php
								$result=mysqli_query($conn,"SELECT * FROM `medica`");
...
{
	$beds = $_POST['beds'];
	$sql="UPDATE `medica_beds` SET `beds` ='$beds'";
...
<tr>
<?php
								$result=mysqli_query($conn,"SELECT * FROM `medica_open`");
								while($row=mysqli_fetch_assoc($result))
								{
