...
<th><img src="img/jimsh.jpg" align="left" width="120px" height="120px" class="zoom">
</th>
<th>
<h1 align="center"><font color ="white">Jagannath Gupta Institute of Medical Science & Hospital</font></h1>
<h3 align="center"><font color ="white">Address:K.P.Mondal Road, Buita, Budge Budge, Kolkata - 700137</font></h3>
<h4 align="center"><font color ="white"><b><i class="fa fa-phone" style="font-size:18px"></i>  (+91) (033) 2482 3500 / 9903396230</b></h4></font>
</th>
<th>
...
<div id="main">
					...
					<center>
                    	<table border="0" cellpadding="2" cellspacing="10">
                            ...
                            <?php
								$result=mysqli_query($conn,"SELECT * FROM `jims`");
...
{
	$beds = $_POST['beds'];
	$sql="UPDATE `jims_beds` SET `beds` ='$beds'";
...
<tr>
<?php
								$result=mysqli_query($conn,"SELECT * FROM `jims_open`");
								while($row=mysqli_fetch_assoc($result))
								{
