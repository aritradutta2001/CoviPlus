...
<body bgcolor="#F1F3F6">
<table border="0" width="100%" height="20%" bgcolor="#2874F0">
<th><img src="img/apollo.jpg" align="left" width="120px" height="120px" class="zoom">
</th>
<th border="1">
<h1 align="center"><font color ="white">Apollo Gleneagles Hospital</font></h1>
<h3 align="center"><font color ="white">58, Canal Circular Road, Kadapara, Phool Bagan, Kolkata - 700054</font></h3>
<h4 align="center"><font color ="white"><b><i class="fa fa-phone" style="font-size:18px"></i>   +91-33-23203040/23202122</b></h4></font>
</th>
<th>
...
<div id="main">
					...
					<center>
                    	<table border="0" cellpadding="2" cellspacing="10">
                            ...
                            <?php
								$result=mysqli_query($conn,"SELECT * FROM `apollo`");
...
{
	$beds = $_POST['beds'];
	$sql="UPDATE `apollo_beds` SET `beds` ='$beds'";
...
<tr>
<?php
								$result=mysqli_query($conn,"SELECT * FROM `apollo_open`");
								while($row=mysqli_fetch_assoc($result))
								{
