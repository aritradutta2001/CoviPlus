...
if(isset($_POST["submit"]))
{
	...
	$sql = "SELECT * FROM tagore WHERE aadhaar_number='$aadhaar_number'";
	...
	{
	$sql="insert into tagore(name,username,main_date,date,sex,address,pincode,bg,aadhaar_number,phone)Values('$name','$username',curdate(),'$date','$sex','$address','$pincode','$bg','$aadhaar_number','$phone')";
...
<body>
<div class="img">
<a href="https://www.google.com/maps/place/Rabindranath+Tagore+International+Institute+Of+Cardiac+Sciences,+Kolkata/@22.4912774,88.4023405,15z/data=!4m5!3m4!1s0x0:0xa56571cbd5cfa88b!8m2!3d22.4912774!4d88.4023405"><button class="loc_btn"><image src="image\location_icon.png" alt="" class="inner-image" /></button>
</a>
<img class="logo"src="image\sub_tagore.jpg" alt="" >
</div>

<div class="container1">
<p class="details"><b>Address :</b>Premises No. 1489, (Postal Address: 124 Mukundapur) E M Bypass,<br>
<b>City :</b> Kolkata - 700099<br>
<b>Phone no :</b> + 91-8420000628<br>
<b>Email :</b> arnab.banerjee01@nhhospitals.org<br></p>

<p class="details"><b>No. of Hospital Beds :</b> 550<br>
<b>No. of ICU Beds :</b> 161<br>
<b>No. of Operating Rooms :</b> 14<br>
...
<div class="close1"><a href="sub_tagore.php" class="close1_link">+</a>
</div>
<h2 class="reg_form1">Registration Form</h2>
		<form action="" method="POST" class="">
			...
			<input list="blood"  class="reg_input1" placeholder="Blood Group" name="bg" value="" required>
									  <datalist id="blood">
										<option value="A+">
										<option value="B+">
										<option value="O+">
...
<div class="about1">
<p>
Rabindranath Tagore International Institute of Cardiac Sciences (RTIICS) Kolkata is a 550 bed full-fledged multi-specialty hospital spread over 4 acres on Eastern Metropolitan Bypass at Mukundapur. RTIICS, a unit of Narayana Health has 14 fully equipped operation theatres and 3 state-of-the-art Catheterization Laboratories with 24 hours facility.
In the last 13 years RTIICS has performed over 26,000 life-saving adult and paediatric cardiac operations, 95,000 cardiac Cath Lab procedures, 900 Kidney Transplants, 250000 dialysis and over 50000 multispecialty surgeries, including joint replacements, minimally invasive surgeries, neuro surgeries and other general surgeries. A dedicated team of renowned surgeons, specialist doctors, nurses, technicians and paramedical staff with the most modern equipment and laboratory has made RTIICS one of the leading hospitals of the Narayana Health group.

<br><br>
RTIICS comprises of 33 major clinical departments that caters to the people of West Bengal and neighbouring districts in Eastern India as well as the North Eastern states. The hospital also has many international patients coming -in from Bangladesh, Nepal, Bhutan, Africa and Myanmar for various treatments and returning home with successful remedies. RTIICS, also popularly called as RN Tagore Hospital is known for its treatment and surgical expertise in;
<br><br>
