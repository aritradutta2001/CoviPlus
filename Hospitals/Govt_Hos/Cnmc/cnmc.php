...
if(isset($_POST["submit"]))
{
	...
	$sql = "SELECT * FROM cnmc WHERE aadhaar_number='$aadhaar_number'";
	...
	{
	$sql="insert into cnmc(name,username,main_date,date,sex,address,pincode,bg,aadhaar_number,phone)Values('$name','$username',curdate(),'$date','$sex','$address','$pincode','$bg','$aadhaar_number','$phone')";
...
<title>Calcutta National Medical College & Hospital</title>
...
<th><img src="img/hospital6.png" align="left" width="120px" height="120px" class="zoom">
<br><br><br><br><br>
...
<th>
<h1 align="center"><font color ="white">Calcutta National Medical College & Hospital</font></h1>
<h3 align="center"><font color ="white">No 24, Gora Chand Road, Beniapukur, Kolkata - 700014, Near Don Bosco School, Park Circus</font></h3>
<h4 align="center"><font color ="white"><b><i class="fa fa-phone" style="font-size:18px"></i>  +(91)-033-22897122..</b></h4></font>
</th>
<th>
<div class="img">
<a href="https://www.google.com/maps/place/Calcutta+National+Medical+College+%26+Hospital/@22.4954631,88.1209132,11z/data=!4m19!1m13!4m12!1m4!2m2!1d88.1508883!2d22.4459311!4e1!1m6!1m2!1s0x3a0276e673d81339:0xe0606cf2ffaf20a6!2sCalcutta+national+medical+college+google+map!2m2!1d88.3714371!2d22.5461737!3m4!1s0x3a0276e673d81339:0xe0606cf2ffaf20a6!8m2!3d22.5461737!4d88.3714371"<button class="loc_btn"><image src="location_icon.png" width="120px" height="120px" /></button></a>
...
<div class="w3-content w3-display-container">               
  <img class="mySlides" src="bg_img/bg_img20.png" width="100%" height="60%">
  <img class="mySlides" src="bg_img/bg_img21.png" width="100%" height="60%">
  <img class="mySlides" src="bg_img/bg_img22.png" width="100%" height="60%">
...
<div class = "img1">
<center><i class="fa fa-phone" style="font-size:18px"  align= "left"></i> 033 22897122,033 22897123,<br>033 22897018,033 22848397,<br>033 22843582,033 22844834
</center>
<br><br>
<center><img src="add.png" style="width=20%" "height :5%" align= "center"> No 24, Gora Chand Road, Beniapukur, Kolkata - 700014, Near Don Bosco School, Park Circus
</center><br><br>
<center><img src="loc.png" style="width=20%" "height :5%" align= "center" >

<a href="http://www.cnmckolkata.com" onclick="_ct('weblink', 'dtpg','','033P50948');" rel="nofollow" target="_BLANK" title="http://www.cnmckolkata.com">
					www.cnmckolkata.com
						</a>
...
<?php
								$result=mysqli_query($conn,"SELECT * FROM `cnmc_open`");
...
<div id="main">
                    	...
                    	<table border="0" cellpadding="2" cellspacing="10" align="center">
                            ...
                            <?php
								$result=mysqli_query($conn,"SELECT * FROM `cnmc_beds`");
								while($row=mysqli_fetch_assoc($result))
								{
...
<div class="close"><a href="cnmc.php">+</a>
</div>
...
var rating_data = 0;
    ...
    $('#save_review').click(function(){
        ...
        {
            $.ajax({
                url:"ratings/submit_rating_cnmc.php",
                method:"POST",
...
<div class="about1">
<p>The Calcutta National Medical College and Hospital is a medical education and research institution in Kolkata. It was established by the amalgamation of the National Medical Institute (estd. 1921) and Calcutta Medical Institute.
</p>
<p>The "Calcutta National Medical College" has its origin in the "National Medical Institute" or "Jatiya Ayurbigyan Vidyalaya" on 14 April 1921,[1] founded as a product of the Non-cooperation movement. It was inaugurated by Netaji Subhas Chandra Bose. The College is locally known as Chittaranjan Hospital. Established in 1948, the institute was nationalized in 1967. The college is accredited by the Medical Council of India (MCI). It was affiliated with the University of Calcutta till 2003. It is currently affiliated to the West Bengal University of Health Sciences.
</p>
<p>
The founder principal of the college was Dr Sundari Mohan Das.</p>
<p>
Calcutta National Medical College along with Chittaranjan hospital is known as “Calcutta National Medical College and Hospital”. </p>
</div>
</tr>
</body>
</html>