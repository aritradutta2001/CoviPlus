...
if(isset($_POST["submit"]))
{
	...
	$sql = "SELECT * FROM r_j_kar WHERE aadhaar_number='$aadhaar_number'";
	...
	{
	$sql="insert into r_j_kar(name,username,main_date,date,sex,address,pincode,bg,aadhaar_number,phone)Values('$name','$username',curdate(),'$date','$sex','$address','$pincode','$bg','$aadhaar_number','$phone')";
...
<html>
<head>
<title>R.G.Kar Medical College & Hospital</title>	
...
<th><img src="img/hospital4.png" align="left" width="120px" height="120px" class="zoom">
<br><br><br><br><br>
...
<th>
<h1 align="center"><font color ="white">R.G.Kar Medical College & Hospital</font></h1>
<h3 align="center"><font color ="white"> Building No 1, Khudiram Bose Sarani, Shyambazar, Kolkata - 700004</font></h3>
<h4 align="center"><font color ="white"><b><i class="fa fa-phone" style="font-size:18px"></i>  +(91)-033-25304557..</b></h4></font>
</th>
<th>
<div class="img">
<a href="https://www.google.com/maps/place/R+G+KAR+MEDICAL+COLLEGE/@22.5245404,88.1244711,11z/data=!4m19!1m13!4m12!1m4!2m2!1d88.1508883!2d22.4459311!4e1!1m6!1m2!1s0x3a0277c174650abd:0x5ae8e0074619fab9!2sR.G.Kar+medical+college+google+map!2m2!1d88.3783475!2d22.6043284!3m4!1s0x3a0277c174650abd:0x5ae8e0074619fab9!8m2!3d22.6043284!4d88.3783475"<button class="loc_btn"><image src="location_icon.png" width="120px" height="120px" /></button></a>
...
<div class="w3-content w3-display-container">               
  <img class="mySlides" src="bg_img/bg_img13.png" width="100%" height="60%">
  <img class="mySlides" src="bg_img/bg_img14.png" width="100%" height="60%">
  <img class="mySlides" src="bg_img/bg_img15.png" width="100%" height="60%">
  <img class="mySlides" src="bg_img/bg_img16.png" width="100%" height="60%">
</div>
<script>
var myIndex = 0;
carousel();
...
<div class="img1">
<center><i class="fa fa-phone" style="font-size:18px"  align= "left"></i> 033 25304557,033 25557676,<br>033 25557656
</center>
<br><br>
<center><img src="add.png" style="width=20%" "height :5%" align= "center"> Building No 1, Khudiram Bose Sarani, Shyambazar, Kolkata - 700004
</center><br><br>
<center><img src="loc.png" style="width=20%" "height :5%" align= "center" >

<a href="http://www.rgkarmch.org" onclick="_ct('weblink', 'dtpg','','033P900002');" rel="nofollow" target="_BLANK" title="http://www.rgkarmch.org">
					www.rgkarmch.org
						</a>
...
<center><a href="mailto:principal.rgkarmc@gmail.com" style="color: rgb(17, 85, 204);" target="_blank">principal.rgkarmc@gmail.com</a>
</center>
...
<?php
								$result=mysqli_query($conn,"SELECT * FROM `r_j_kar_open`");
...
<div id="main">
                    	...
                    	<table border="0" cellpadding="2" cellspacing="10" align="center">
                            ...
                            <?php
								$result=mysqli_query($conn,"SELECT * FROM `r.j.kar_beds`");
								while($row=mysqli_fetch_assoc($result))
								{
...
<div class="close"><a href="r_j_kar.php">+</a>
</div>
...
<h2 class="reg_form1" >Registration Form</h2>
		<form action="" method="POST" class="form-submit">
			...
			<div class="input-form">
				...
				<input list="sex" class="reg_input1" name="sex" placeholder="sex" required>
							  <datalist id="sex">
								<option value="Male">
								<option value="Female">
								<option value="Others">
...
var rating_data = 0;
    ...
    $('#save_review').click(function(){
        ...
        {
            $.ajax({
                url:"ratings/submit_rating_r.j.kar.php",
                method:"POST",
...
<p>The history of genesis of R.G.Kar Medical College dates back to later half of the Nineteenth Century. Then, our country was under the British rule. The influence of English literature and culture was gradually creeping in to the minds of the young society. This was gradually clearing the superstations prevailing in the society. Simultaneously a great sense of Nationalism was growing among all sections of the population. The public health was in an appalling state in Calcutta and rest of Bengal. The diseased population was at mercy of untrained physicians and quack doctors.</p>
