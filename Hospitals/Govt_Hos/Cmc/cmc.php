...
if(isset($_POST["submit"]))
{
	...
	$sql = "SELECT * FROM cmc WHERE aadhaar_number='$aadhaar_number'";
	...
	{
	$sql="insert into cmc(name,username,main_date,date,sex,address,pincode,bg,aadhaar_number,phone)Values('$name','$username',curdate(),'$date','$sex','$address','$pincode','$bg','$aadhaar_number','$phone')";
...
<th>
<div class="img">
<a href="https://www.google.com/maps/place/Medical+College+%26+Hospital,+Kolkata/@22.4820758,88.1188481,11z/data=!4m19!1m13!4m12!1m4!2m2!1d88.1508883!2d22.4459311!4e1!1m6!1m2!1s0x3a0277c71a2602d1:0x8f1082508681bb61!2sCalcutta+medical+college+google+map!2m2!1d88.3618516!2d22.5735705!3m4!1s0x3a0277c71a2602d1:0x8f1082508681bb61!8m2!3d22.5735705!4d88.3618516"<button class="loc_btn"><image src="location_icon.png" width="120px" height="120px" /></button></a>
...
<div class="w3-content w3-display-container">               
  <img class="mySlides" src="bg_img/bg_img17.png" width="100%" height="60%">
  <img class="mySlides" src="bg_img/bg_img18.png" width="100%" height="60%">
  <img class="mySlides" src="bg_img/bg_img19.png" width="100%" height="60%">
...
<div class = "img1">
<center><i class="fa fa-phone" style="font-size:18px"  align= "left"></i> 033 22551633,033 22123853,<br>033 22551621
</center>
<br><br>
<center><img src="add.png" style="width=20%" "height :5%" align= "center"> No 88, College Street, Chittaranjan Avenue, Kolkata - 700073
</center><br><br>
<center><img src="loc.png" style="width=20%" "height :5%" align= "center" >

<a href="http://www.medicalcollegekolkata.in" onclick="_ct('weblink', 'dtpg','','033P51271');" rel="nofollow" target="_BLANK" title="http://www.medicalcollegekolkata.in">
					www.medicalcollegekolkata..
						</a>
...
<br><h3 align="left">Available Beds :</h3>
<div id="main">
...
<div class="close"><a href="cmc.php">+</a>
</div>
...
var rating_data = 0;
    ...
    $('#save_review').click(function(){
        ...
        {
            $.ajax({
                url:"ratings/submit_rating_cmc.php",
                method:"POST",
...
<div class="about1">
<p>Calcutta Medical College, officially Medical College and Hospital, Kolkata, is a public medical school and hospital in Kolkata, West Bengal, India. The institute was established on 28 January 1835 by Lord William Bentinck during British Raj as Medical College, Bengal.
</p>
<p>It is the second oldest medical college to teach Western medicine in Asia after Ecole de Médicine de Pondichéry and the first institute to teach in English language. The hospital associated with the college is the largest hospital in West Bengal. The college offers MBBS degree after five and a half years of medical training.
</p>
</div>
</tr>
</body>
