...
if(isset($_POST["submit"]))
{
	...
	$sql = "SELECT * FROM id_bg WHERE aadhaar_number='$aadhaar_number'";
	...
	{
	$sql="insert into id_bg(name,username,main_date,date,sex,address,pincode,bg,aadhaar_number,phone)Values('$name','$username',curdate(),'$date','$sex','$address','$pincode','$bg','$aadhaar_number','$phone')";
...
<th><img src="img/hospital3.png" align="left" width="120px" height="120px" class="zoom">
<br><br><br><br><br>
...
<th>
<h1 align="center"><font color ="white">ID & BG Hospital</font></h1>
<h3 align="center"><font color ="white">No 57, Beliaghata Main Road, Beliaghata, Kolkata - 700010, Subhas Sarobar Park, Phool Bagan</font></h3>
<h4 align="center"><font color ="white"><b><i class="fa fa-phone" style="font-size:18px"></i>  +(91)-033-23002248..</b></h4></font>
</th>
<th>
<div class="img">
<a href="https://www.google.com/maps/place/Beleghata+I.D.+And+B.G.+Hospital,+57,+Beleghata+Main+Rd,+Subhas+Sarobar+Park,+Phool+Bagan,+Beleghata,+Kolkata,+West+Bengal+700010/@22.5036245,88.1412827,11z/data=!4m19!1m13!4m12!1m4!2m2!1d88.1508883!2d22.4459311!4e1!1m6!1m2!1s0x3a027680f331aad1:0xd8f78431a8f73b1f!2sid+and+bg+google+map!2m2!1d88.3985613!2d22.5624966!3m4!1s0x3a027680f331aad1:0xd8f78431a8f73b1f!8m2!3d22.5624966!4d88.3985613"<button class="loc_btn"><image src="location_icon.png" width="120px" height="120px" /></button></a>
...
<div class="w3-content w3-display-container">               
  <img class="mySlides" src="bg_img/bg_img9.png" width="100%" height="60%">
  <img class="mySlides" src="bg_img/bg_img10.png" width="100%" height="60%">
  <img class="mySlides" src="bg_img/bg_img11.png" width="100%" height="60%">
...
<div class = "img1">
<center><i class="fa fa-phone" style="font-size:18px"  align= "left"></i> 033 23002248
</center>
<br><br>
<center><img src="add.png" style="width=20%" "height :5%" align= "center"> No 57, Beliaghata Main Road, Beliaghata, Kolkata - 700010, Subhas Sarobar Park, Phool Bagan
</center><br><br>
<center><img src="loc.png" style="width=20%" "height :5%" align= "center" >

<a href="http://www.wbidbghospital.com" onclick="_ct('weblink', 'dtpg','','033PXX33.XX33.171127151052.G6W5');" rel="nofollow" target="_BLANK" title="http://www.wbidbghospital.com">
					www.wbidbghospital.com
						</a>
...
<center><a href="mailto:prin_idbg@wbhealth.gov.in" style="color: rgb(17, 85, 204);" target="_blank">prin_idbg@wbhealth.gov.in</a>
</center>
<center>
...
<?php
								$result=mysqli_query($conn,"SELECT * FROM `id_bg_open`");
...
<div id="main">
                    	...
                    	<table border="0" cellpadding="2" cellspacing="10" align="center">
                            ...
                            <?php
								$result=mysqli_query($conn,"SELECT * FROM `id_bg_beds`");
								while($row=mysqli_fetch_assoc($result))
								{
...
<div class="close"><a href="id_bg.php">+</a>
</div>
...
var rating_data = 0;
    ...
    $('#save_review').click(function(){
        ...
        {
            $.ajax({
                url:"ratings/submit_rating_id_bg.php",
                method:"POST",
...
<div class="about1">
<p>Infectious Diseases and Beliaghata General Hospital started its journey in the year 1957 by inspiration of Dr. Bidhan Chandra Roy. Originally starting as an institute for treating infectious diseases like small pox, diphtheria, cholera, gradually we stepped in new buildings having wards of separate Infection Diseases and Beliaghata General Hospital and in 1990 it was turned into a teaching institution. It started Nursing training school for training of ANMs and Nursing College for B.Sc. and M.Sc. Nursing Course in recent years.</p>
<p>From 2014 we started 10 bedded Critical Care unit and Dialysis Unit (in PPP Mode). We have a well-functioning Dept. of Laboratory Medicine.</p>
<p>National Institute of Cholera & Enteric Diseases a part of Indian Council of Medical Research started their second campus within the premises of ID & BG Hospital in 2006. There is a microbiology laboratory including virology unit of ICMR within our building. They are helping us in eitiological diagnosis. We have urban and rural field practice are regularly being visited by our nursing students. We are also working as an apex institution for Post exposure prophylaxes of animal bites.

We have applied for starting different training courses and post graduate course on infectious diseases. We are looking forward to achieve more in future with the help of Government of West Bengal.</p>
</div>
</tr>
</body>
</html>